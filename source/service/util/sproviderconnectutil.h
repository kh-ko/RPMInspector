...
#define ENABLE_SLOT_LSETTING_CHANGED_PDSETTING         connect(LocalSettingSProvider::getInstance(), SIGNAL(signalEventChangedPDSetting(QString, PDSettingDto)), this, SLOT(onChangedPDSetting(QString, PDSettingDto)))
...
#define ENABLE_SLOT_LSETTING_DELETED_PDSETTING         connect(LocalSettingSProvider::getInstance(), SIGNAL(signalEventDeletedPDSetting(QString)              ), this, SLOT(onDeletedPDSetting(QString)              ))
